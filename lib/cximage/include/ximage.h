...
typedef struct tagCxImageInfo {
	...
	char    cImageInfo[2048];			//zjy add ------------20130916-----------------------------
...
/** \addtogroup Initialization */ //@{
	...
	//
	static DWORD GetFileTypeByExt( char * pszFileName); //qu yang 2003,3,27
	static DWORD GetFileTypeByExt( const char * pszFileName);
//@}
...
/** \addtogroup Transformations */ //@{
	...
	//-----zjy----add--------start----------------
	bool Resample_zjy(int32_t newx, int32_t newy, bool bChangeColorBlock,int32_t mode=1, CxImage* iDst=NULL);//zjy  add --20131011---
	const char*	GetTiffImageDescription(void);
	//-----zjy----add--------end----------------
